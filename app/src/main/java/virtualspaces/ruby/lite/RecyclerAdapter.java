...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerAdapter(List<Object> inputList, RecyclerView recyclerView) {
        itemList = inputList;
        handler = new Handler(recyclerView.getContext().getMainLooper());
        ...
        if (prefs.getBoolean("grid", false)) {
            switch (viewType) {
                ...
                case LOADING:
                    ...
                    break;
                case AUDIO:
                    View dv = inflater.inflate(R.layout.grid_audio, parent, false);
                    viewHolder = new AudioViewHolder(dv);
                    break;
            }
        } else {
            ...
            switch (viewType) {
                ...
                case LOADING:
                    ...
                    break;
                case AUDIO:
                    View dv = inflater.inflate(R.layout.single_audio, parent, false);
                    viewHolder = new AudioViewHolder(dv);
                    break;
            }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()) {
            case PHOTO:
                ...
                break;
            case PHOTOSET:
                ViewHolderSetup set = new ViewHolderSetup(RecyclerAdapter.PhotosetViewHolder.context, holder, 0, position, itemList, handler, appCompat);
                try {
            ...
            case AUDIO:
                ...
                ViewHolderSetup audio = new ViewHolderSetup(AudioViewHolder.context, audioHolder, 10, position, itemList, handler);
                try {
                    audio.setBasicFunctions();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                break;
