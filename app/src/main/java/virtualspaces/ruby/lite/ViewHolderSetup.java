...
public class ViewHolderSetup {
    ...
    ViewHolderSetup(Context context, Object object, int type, int position, List<Object> list, Handler handler) {
        ...
        try {
            ...
            Log.d(TAG, "ViewHolderSetup: null pointer thrown: " + e.getStackTrace());
        }
    ...
    public void setBasicFunctions() throws IOException {
           ...
           is photoset
            ...
            case 5:
                ...
                */
                ...
                RecyclerAdapter.VideoViewHolder videoHolder = (RecyclerAdapter.VideoViewHolder) object;
            ...
            case 10:
                ...
                audioHolder = (RecyclerAdapter.AudioViewHolder) object;
        ...
        holder.vLike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!((Boolean) holder.vLike.getTag())) {
                    ...
                    holder.vLike.setImageResource(R.drawable.like);
                    holder.vLike.setTag(Boolean.FALSE);
                    //unlike post
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
